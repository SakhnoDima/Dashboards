...
var require_highcharts = __commonJS({
 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        class v {
          ...
          constructor(t3, e3) {
            var _a;
            this.hasDragged = 0, this.eventsToUnbind = [], this.options = e3, this.chart = t3, this.runChartClick = !!((_a = e3.chart.events) == null ? void 0 : _a.click), this.pinchDown = [], this.setDOMEvents(), p(this, "afterInit");
          }
          normalize(t3, e3) {
          ...
          onDocumentMouseUp(t3) {
            var _a, _b;
            (_b = (_a = o[x(v.hoverChartIndex, -1)]) == null ? void 0 : _a.pointer) == null ? void 0 : _b.drop(t3);
          }
          pinch(t3) {
            let e3 = this, { chart: i3, hasZoom: s2, lastTouches: r2 } = e3, o2 = [].map.call(t3.touches || [], (t4) => e3.normalize(t4)), a2 = o2.length, n2 = 1 === a2 && (e3.inClass(t3.target, "highcharts-tracker") && i3.runTrackerClick || e3.runChartClick), h2 = i3.tooltip, l2 = 1 === a2 && x(h2 == null ? void 0 : h2.options.followTouchMove, true);
          ...
          runPointActions(t3, e3, i3) {
            ...
            this.unDocMouseMove || (this.unDocMouseMove = n(s2.container.ownerDocument, "mousemove", (t4) => {
              var _a, _b;
              return (_b = (_a = o[v.hoverChartIndex ?? -1]) == null ? void 0 : _a.pointer) == null ? void 0 : _b.onDocumentMouseMove(t4);
          ...
          setHoverChartIndex(t3) {
            ...
            s2 && s2 !== i3 && ((_a = s2.pointer) == null ? void 0 : _a.onContainerMouseLeave(t3 || { relatedTarget: i3.container })), s2 && s2.mouseIsDown || (v.hoverChartIndex = i3.index);
          }
          touch(t3, e3) {
            let i3;
